...
<c:url var="deleteFeedBackAPI" value="/api/feedBack" />
...
<body class="no-skin">
	...
	<!-- menu -->
		...
		<div class="main-content">
			<form action="<c:url value='/admin/feedback/list'/>" id="formSubmit"
				method="get">
		...
		<script>
			...
			function deleteNew(data) {
				$
						.ajax({
							url : '${deleteFeedBackAPI}',
							type : 'DELETE',
							contentType : 'application/json',
							data : JSON.stringify(data),
							success : function(result) {
								window.location.href = "${feedbackListURL}?page=1&limit=7&message=delete_success";
							},
							error : function(error) {
								window.location.href = "${feedbackListURL}?page=1&limit=7&message=error_system";
							}
						});
			}
		</script>
