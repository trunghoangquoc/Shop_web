...
<body>
	...
	<div class="container" style="margin-top: 40px; margin-bottom: 20px;">
			<form class="form-inline my-2 my-lg-0" style=" margin-bottom: 20px;" action="/shop/productSearch" method="get">
			...
			<div class="row" style="margin-top: 20px;">
				...
				<div class="col-lg-3">
					<div class="card bg-light mb-3">
						...
						<div>
						<button class="btn btn-outline-success my-2 my-sm-0" type="button" style="width: 100%;">
						    <c:url var="productURL1" value="/productCategory1?page=1&limit=8" >
				              <c:param name="category" value="Rau-Cu" />
				              </c:url>
				              
						  <a href='${productURL1}' style="width: 100%; text-decoration: none;">Rau Củ</a>
				      	</button>
						</div>
						<div>
						<button class="btn btn-outline-success my-2 my-sm-0" type="button" style="width: 100%;">
						    <c:url var="productURL2" value="/productCategory2?page=1&limit=8" >
				              <c:param name="category" value="Hoa-Qua" />
				              </c:url>
				              
						  <a href='${productURL2}' style="width: 100%; text-decoration: none;">Hoa Quả</a>
				      	</button>
						</div>
					</div>
				</div>
